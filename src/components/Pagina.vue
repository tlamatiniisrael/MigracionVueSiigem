<template>
  <form name="Mg8" method="POST" id="formulario">
    <div id="pleca-proceso-b">
      <div id="pleca-proceso-logo-b">
...
/*Tramite de Solicitud de Inscripción */
.leyendaPrivacidad2 {
  background: #eeeeee;
  color: #000;
  font-weight: normal;
...
@media only screen and (max-width: 35em) {
  ...
  /*Estilo de erogaciones en jsp */

  /*Aviso de privacidad Erogaciones */
  .leyendaPrivacidadEro {
    background: #87597e;
    color: white;
    font-weight: normal;
    border-radius: 5px;
